...
def test_exact_permissions_for_every_template(session: Session) -> None:
    ...
    expected = {
        ...
        "restaurant_owner": {
            ...
            PermissionCode.BUSINESS_LOCATIONS_VIEW.value,
            PermissionCode.BUSINESS_LOCATIONS_CREATE.value,
            PermissionCode.BUSINESS_LOCATIONS_UPDATE.value,
            PermissionCode.BUSINESS_LOCATIONS_DELETE.value,
